...
#define FLATBUFFERS_GEN_TYPES_POINTER(TD) \
  TD(STRING, "string", Offset<void>, int, int, int, int, isize) \
  TD(VECTOR, "",       Offset<void>, int, int, int, int, isize) \
  TD(STRUCT, "",       Offset<void>, int, int, int, int, isize) \
  TD(UNION,  "",       Offset<void>, int, int, int, int, isize)
